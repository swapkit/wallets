...
export const CHAIN_CATALOG: ReadonlyArray<ChainCatalogEntry> = [
  ...
  { chain: Chain.Aleo, color: "#00C3FF", name: "Aleo" },
  { chain: Chain.Robinhood, color: "#ccff00", name: "Robinhood" },
  { chain: Chain.Hyperevm, color: "#97fce4", name: "HyperEVM" },
  { chain: Chain.Hype, color: "#50d2c1", name: "Hyperliquid" },
];
...
const CHAIN_NATIVE_ASSET: Partial<Record<Chain, string>> = {
  [Chain.Aleo]: "ALEO.ALEO",
  [Chain.Arbitrum]: "ARB.ETH",
  [Chain.Robinhood]: "HOOD.ETH",
  [Chain.Hyperevm]: "HYPEREVM.HYPE",
  [Chain.Hype]: "HYPE.HYPE",
