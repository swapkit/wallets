...
const SINGLE_CHAIN_CONNECT_WALLETS = new Set<WalletOption>([WalletOption.LEDGER, WalletOption.TREZOR]);

// Values annotated as WalletOption[]: since helpers 5.1.0 the WalletOption registry members are
// literal types, so unannotated collections infer per-group literal unions that reject the wider
// WalletOption values flowing through the filter pipelines below.
const WALLET_GROUPS: Record<"Browser Extensions" | "Hardware Wallets" | "Mobile Wallets" | "Other", WalletOption[]> = {
  "Browser Extensions": [
    WalletOption.BITGET,
    WalletOption.BRAVE,
