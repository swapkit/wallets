...
import { ArrowRight, CheckCircle2, ExternalLink, History, ShieldCheck, Trash2, XCircle } from "lucide-react";
      ...
      <div className="sk-ui-flex sk-ui-min-w-0 sk-ui-flex-1 sk-ui-flex-col sk-ui-gap-1">
        <div className="sk-ui-flex sk-ui-items-center sk-ui-justify-between sk-ui-gap-2">
          <div className="sk-ui-flex sk-ui-items-center sk-ui-gap-2">
            ...
            {transaction.shieldedDeliveryHash ? (
              <span className="sk-ui-flex sk-ui-items-center sk-ui-gap-1 sk-ui-rounded-full sk-ui-bg-[#00C3FF]/10 sk-ui-px-2 sk-ui-py-0.5 sk-ui-font-medium sk-ui-text-[#00A3D4] sk-ui-text-xs">
                <ShieldCheck className="sk-ui-size-3" />
                Shielded
              </span>
            ) : null}
          </div>
