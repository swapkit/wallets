...
type SwapAssetItemProps = { asset: string | null | undefined; className?: string; ref?: Ref<HTMLDivElement> };

export function SwapAssetItem({ asset, className, ref }: SwapAssetItemProps) {
