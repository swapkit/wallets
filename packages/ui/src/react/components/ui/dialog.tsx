...
const DialogContent = ({
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      className={cn(
        "swapkit-ui-preflight data-[state=closed]:sk-ui-fade-out-0 data-[state=open]:sk-ui-fade-in-0 data-[state=closed]:sk-ui-zoom-out-95 data-[state=open]:sk-ui-zoom-in-95 data-[state=closed]:sk-ui-slide-out-to-left-1/2 data-[state=closed]:sk-ui-slide-out-to-top-[48%] data-[state=open]:sk-ui-slide-in-from-left-1/2 data-[state=open]:sk-ui-slide-in-from-top-[48%] sk-ui-fixed sk-ui-top-[50%] sk-ui-left-[50%] sk-ui-z-50 sk-ui-grid sk-ui-max-h-[90svh] sk-ui-w-full sk-ui-max-w-lg sk-ui-translate-x-[-50%] sk-ui-translate-y-[-50%] sk-ui-gap-4 sk-ui-border sk-ui-border-border sk-ui-bg-secondary sk-ui-p-6 sk-ui-shadow-none sk-ui-duration-200 data-[state=closed]:sk-ui-animate-out data-[state=open]:sk-ui-animate-in sk-ui-rounded-lg [&_*]:sk-ui-border-border",
        className,
      )}
      ref={ref}
      {...props}>
